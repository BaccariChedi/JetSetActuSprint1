...
public class Voirnotesadmin extends javax.swing.JFrame {

    /**
     * Creates new form Accueil
     */
    public Voirnotesadmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        nbrvues = new javax.swing.JTextField();
        ...
        jLabel1.setText("Vous voulez voir les notes de quelle  rubrique:");

        choix.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "News", "Arts", "Films", "Soirées" }));
        ...
        nbrvues.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        nbrvues.setText("     ");
        nbrvues.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nbrvuesActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(inputChoix, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                .addGap(273, 273, 273)
                .addComponent(nbrvues, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(choix, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(inputChoix, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(chercher, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(95, 95, 95)
                .addComponent(nbrvues, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void chercherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chercherActionPerformed
         ...
         nbrvues.setText(String.valueOf(Evenement.getNbrVue()));
 ...
 if(choix.getSelectedIndex()==2)
        {         
         UserDAO usedao=new UserDAO();
            ...
            EvenementDAO evdao=new EvenementDAO();
            Evenement Evenement =new Evenement();
            Evenement=evdao.findEvenementByTitre(inputChoix2.getText());
            user=usedao.findCUserByNomOrPrenom(inputChoix.getText());
...
*/
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Voirnotesadmin().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField nbrvues;
