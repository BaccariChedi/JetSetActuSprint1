...
//    rawJsonResponse();
  ...
  entities.User fetchObject() {
    out.println("* Fetching single objects *");

    User user = facebookClient.fetchObject("me", User.class);
    Page page = facebookClient.fetchObject("cocacola", Page.class);
     entities.User  uFB=new entities.User();
     uFB.setNom(user.getLastName());
     uFB.setPrenom(user.getName());
      uFB.setAdresse(user.getHometownName());
      uFB.setDateNaissance(user.getBirthday());
      uFB.setEmail(user.getEmail());
      
    out.println("Name: " + user.getName());
    out.println("Name: " + user.getLastName());
